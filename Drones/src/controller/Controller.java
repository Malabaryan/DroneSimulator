...
public class Controller {
    ...
    /**
     * Return an array of Stations with X & Y positions on the map. 
     * Controled Random positions.
     * @param weightMap
     * @param heightMap
     * @param stationCount
     * @return 
    ...
    public void runSimulation(int HeightTrack, int WeightTrack, int stationCount, int SimulationTime, int dronesCount,int secondsByAnSimulateHour, int tracksByStation){
